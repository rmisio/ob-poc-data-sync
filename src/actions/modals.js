 ...
 * open instances of that modal will be closed, which is probably not what you want.
 * To close a specific non-singleton instance, be sure to pass in the modal id.
 */
