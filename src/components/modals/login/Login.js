  ...
  constructor(props) {
    ...
    this.state = {
      ...
      loginForm: {
        seed: '',
        loginType:
          props.lsLogin && props.lsLogin.lastLoginType === 'seed' &&
  ...
  validateLoginForm(data = this.state.loginForm) {
    ...
    if (data.loginType === 'seed') {
      ...
      if (typeof this.state.loginForm.account !== 'string' || !this.state.loginForm.account) {
        ...
        errors.account.push('The account must be provided as a non-empty string.');
      }
    }
  ...
  handleLoginClick = e => {
    ...
    if (loginFormErrors) {
      ...
      if (this.state.loginForm.loginType === 'seed') {
        ...
        this.props.actions.user.loginViaPassword(encryptedSeed, this.state.loginForm.password);
      }
    }
      ...
      loginSubContent = (
        <div>
          <div className="row">
            ...
            {
              this.state.loginFormErrors && this.state.loginFormErrors.account ?
                <ErrorList errors={this.state.loginFormErrors.account} /> : null
            }
            <select id="loginAccount" name="account"
          ...
          <div className="row">
            ...
            {
              this.state.loginFormErrors && this.state.loginFormErrors.password ?
                <ErrorList errors={this.state.loginFormErrors.password} /> : null
            }
            <input type="password" onChange={this.handleLoginFormInputChange}
              id="loginPassword"
              name="password"
      ...
      <div>
        ...
        <form>
          <div className="row">
            ...
            {
              this.state.loginFormErrors && this.state.loginFormErrors.loginType ?
                <ErrorList errors={this.state.loginFormErrors.loginType} /> : null
            }
          ...
          <p>Don't have an account? You can <a onClick={this.handleRegisterClick}>register</a> here.</p>
          <div className="flexRow gutterH">
    ...
    if (this.state.phase.startsWith('register')) {
      ...
      if (this.state.phase === 'registerEncryptSeed') {
        ...
        registerSubContent = (
          <div>
            <p className="txB">
              It is strongly encouraged that you encrypt your seed on this device. This will
              allow you to login with an easier to remember password of your choosing instead
              of having to continuously expose your seed.
            </p>
            <form>
              <div className="row">
                <label htmlFor="registerPassword">Enter password:</label>
                {
                  ...
                  this.state.registerFormErrors.registerPassword ?
                    <ErrorList errors={this.state.registerFormErrors.registerPassword} /> :
                      null
                }
                <input type="password" onChange={this.handleRegisterFormInputChange}
              ...
              <div className="row">
                <label htmlFor="registerPasswordConfirm">Confirm password:</label>
                {
                  ...
                  this.state.registerFormErrors.registerPasswordConfirm ?
                    <ErrorList errors={this.state.registerFormErrors.registerPasswordConfirm} /> :
                      null
                }
                <input type="password" onChange={this.handleRegisterFormInputChange}
              ...
              <div className="flexVCent flexRow gutterH">
                ...
                <div className="posR">
                  {encryptOptOutConfirmBox}
                  <button onClick={this.handleRegisterSubmitClick}>Register</button>
                </div>
              </div>
            </form>
          </div>
